...
public class DungeonGeneration : MonoBehaviour
{
    ...
    private Room GenerateDungeon()
    {
        ...
        while (roomsToCreate.Count > 0 && createdRooms.Count < numberOfRooms)
        {
            ...
            AddNeigbors(currentRoom, roomsToCreate);
        }
        ...
        foreach (Room room in createdRooms)
        {
            ...
            {
                Room neighbor = this.rooms[coordinates.x, coordinates.y];
                if(neighbor != null)
                {
    ...
    private void AddNeigbors(Room currentRoom, Queue<Room> roomsToCreate)
    {
